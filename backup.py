...
def main():
    ...
    access_id = "ASIA2PPXPGLCMAQLVIWD"
    secret_key = "FH+QGytImRM7nRyypKZCBSR4hfpCl/+y1SmlQqxV"
    session_token = ""
...
CREATE TABLE test_db.Guests (id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY,firstname VARCHAR(30) NOT NULL,count INT(6));
INSERT into test_db.Guests (firstname, count) VALUES ("Elisabeth", 10);
INSERT into test_db.Guests (firstname, count) VALUES ("David", 8);
INSERT into test_db.Guests (firstname, count) VALUES ("Axel", 9);
EOF

# 6.4 install gedit for debugging
...
sudo mv ~/TeamProject-SoSe21-TeamB/app.php ../../var/www/html
sudo mv ~/TeamProject-SoSe21-TeamB/data.json ../../var/www/html

sudo rm -r ../../var/www/html/index.nginx-debian.html

sudo chmod +x ../../var/www/html/app.js
sudo chmod +x ../../var/www/html/index.html
sudo chmod +x ../../var/www/html/app.php
sudo chmod +x ../../var/www/html/data.json
